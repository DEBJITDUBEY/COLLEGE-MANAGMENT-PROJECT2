<%-- 
    Document   : addmarks2
    Created on : Jul 23, 2018, 1:05:08 PM
    Author     : Debjit
--%>
...
{margin-top:20px;
 ...
 <body>
  ...
  name=rs.getString(1);
    ...
    %>
    <form action="submit.jsp" class="form-control">
        ...
        <% out.println(rs.getString(5));%> 
           			          ...
           			          <input type="submit" href="submit.jsp" data-toggle="modal" data-target="#myModal" value="Submit">
